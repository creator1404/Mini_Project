        ...
        if frame is not None:
            ...
            if method==1:
                ...
                if(num_frames<30):
                    ...
                    cv2.putText(clone, "Keep the Camera still.", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 1)
                else:
                    cv2.putText(clone, "Press esc to exit.", (10, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
                    cv2.putText(clone, "Keep the Camera still.", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 1)
                    cv2.putText(clone, "Put your hand in the rectangle", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.5,(0, 0, 0), 1)
                    cv2.putText(clone, "Press the key of the sample", (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5,(0, 0, 0), 1)
                    ...
                    if hand is not None:
                        ...
                        if desc is not None:
                            ...
                            cv2.putText(clone,output, (10, 300), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 0), 2)'''
                        ...
                        if res is not None and cv2.contourArea(max_cont) > 1000:
                            ...
                            cv2.putText(clone, 'Sign ' + str(final_sign), (20, 280),cv2.FONT_HERSHEY_SIMPLEX, 2,
                                 (0, 0, 255), 3)
                            ...
                            if (count > 10 and count <= 50):
                                ...
                                if len(result_list):
                                    ...
                                    prev_sign = predict_sign
                                # print(words_list)
                                # cv2.putText(clone,'Sign'+str(predict_sign), (100, 300), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 0))
                ...
                cv2.putText(clone, "Put your hand in the rectangle", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1 )
                cv2.putText(clone, "Adjust the values using trackbar", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.5,(0, 0, 0), 1)
                cv2.putText(clone, "Press the key of the sample", (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
                cv2.putText(clone, "Press esc to exit.", (10, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
